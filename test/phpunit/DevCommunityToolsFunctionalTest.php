...
/**
 * \file    test/phpunit/DevCommunityToolsFunctionalTest.php
...
/**
 * Class DevCommunityToolsFunctionalTest
 *
 ...
 *
 * @package Testdevcommunitytools
 */
class DevCommunityToolsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 490000; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDevCommunityTools')->click();
		} else {
			// Disable the module
			$this->byHref('modDevCommunityTools')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/devcommunitytools/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('devcommunitytools/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/devcommunitytools/admin/about.php');
		$this->authenticate();
		return $this->assertContains('devcommunitytools/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('devcommunitytoolswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDevCommunityTools_DevCommunityToolsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDevCommunityTools_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
